...
const SEOUL_DONG = {
    ...
    "성동구": ["왕십리도선동", "왕십리제2동", "마장동", "사근동", "행당제1동", "행당제2동", "응봉동", "금호1가동", "금호2·3가동", "금호4가동", "옥수동", "성수1가제1동", "성수1가제2동", "성수2가제1동", "성수2가제2동", "송정동", "용답동"],
    "광진구": ["중곡제1동", "중곡제2동", "중곡제3동", "중곡제4동", "능동", "구의제1동", "구의제2동", "구의제3동", "광장동", "자양제1동", "자양제2동", "자양제3동", "자양제4동","화양동", "군자동"],
    "동대문구": ["용신동", "제기동", "전농제1동", "전농제2동", "답십리제1동", "답십리제2동", "답십리제3동", "장안제1동", "장안제2동", "청량리동", "회기동", "휘경제1동", "휘경제2동", "이문제1동", "이문제2동"],
    "중랑구": ["면목본동", "면목제2동", "면목제3·8동", "면목제4동", "면목제5동", "면목제7동", "상봉제1동", "상봉제2동", "중화제1동", "중화제2동", "묵제1동", "묵제2동", "망우본동", "망우제3동", "신내제1동", "신내제2동"],
            ...
            operate_status.innerHTML += "<div class='gu'>" +
                ...
                (() => {
                    ...
                    SEOUL_DONG[gu].forEach(dong => {
                        ...
                        htmlString += "<li class='dong'>" +
                        `<div><span class='status ${status_class}'></span></div>` +
